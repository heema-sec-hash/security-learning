* the whole terminal thing with outcomes is still confusing for me. do i need to understand the kind of output i get everytime I'm using a code/command? meaning, what are those files and what can i do with them? can i access them and have a peak? blah blah blah, etc...
